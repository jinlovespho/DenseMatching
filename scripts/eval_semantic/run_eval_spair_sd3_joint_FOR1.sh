    ...
    for feat_type in mmdit_attn; do
        ...
        for layer in 9; do
            ...
            MODEL_ARGS="
                ...
                --feat_save_path ./extracted_feats/spair_sd3_joint/maxstep28_stopstep${stop_step}_${feat_type}_layer${layer} \
            "
            ...
            LOG_ARGS="
                ...
                --wandb_exp_name server5_spair_sd3_joint_EVALSAMPLE20_maxstep28_stopstep${stop_step}_${feat_type}_layer${layer}_gpu${CUDA} \
                --save_dir ./vis/spair/sd3_joint/EVALSAMPLE20_maxstep28_stopstep${stop_step}_${feat_type}_layer${layer} \
            "
