...
CUDA_VISIBLE_DEVICES=${CUDA} python -u eval_matching.py \
    ...
    --path_to_pre_trained_models /media/dataset3/honggyu_log/train_settings/croco/train_croco_static_multigpu_2stage/hg0,1,6,7_TRAIN_dpedcocomega_img224_bs12_lr1e3_croco_catseg_uncertainty1e4_newweight/CroCoNet_ep0045.pth.tar \
    --output_flow_interp \
    --output_ca_map \
    --softmax_camap \
    --correlation \
    --reciprocity \
    --uncertainty \
    --save_dir ./vis/eval/zoom23_hp_stage2_hongyu_dpedcocomega_img224_bs12_lr1e3_croco_catseg_uncertainty1e4_newweight_CroCoNet_ep0045_fineflow \
    --log_tool wandb \
    --wandb_path ./ \
    --wandb_proj_name matching_dped \
    --wandb_exp_name pho_EVAL_zoom23_hp_stage2_hongyu_dpedcocomega_img224_bs12_lr1e3_croco_catseg_uncertainty1e4_newweight_CroCoNet_ep0045_fineflow \
    --wandb_log_img \
