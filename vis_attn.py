        ...
        for pre_trained_model_type in args.pre_trained_models:
            ...
            if args.dataset == 'megadepth':
                output = run_evaluation_megadepth_or_robotcar(network, settings.env.megadepth,
                                                            ...
                                                            plot_ind_images=args.plot_individual_images, args=args, vis_attn=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--cost_agg', type=str, help='Cost aggregation')
    ...
    parser.add_argument('--cats_depth', type=int)
