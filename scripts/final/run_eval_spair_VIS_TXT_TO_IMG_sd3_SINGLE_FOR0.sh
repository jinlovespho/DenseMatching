        ...
        for layer in 10; do
            ...
            for inf_step_count in 1; do
                ...
                LOG_ARGS="
                    ...
                    --wandb_exp_name server5_spair_SORTED_VALSPLIT360_sd3_SINGLE_step_max28_stop${stop_step}_count${inf_step_count}_${feat_type}_layer${layer}_gpu${CUDA} \
                    --save_dir ./vis/spair_SORTED_VALSPLIT360/sd3_SINGLE/step_max28_stop${stop_step}_count${inf_step_count}_${feat_type}_layer${layer} \
                "
