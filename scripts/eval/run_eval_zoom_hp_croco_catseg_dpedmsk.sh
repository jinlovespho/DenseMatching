...
CUDA_VISIBLE_DEVICES=${CUDA} python -u eval_matching.py \
    ...
    --correlation \
    --reciprocity \
    --save_dir ./vis/eval/zoom23_hp_dpedmsk_img224_bs12_lr1e4_croco_catseg_freezeCrocoAll_try1_CroCoNet_ep0057_fineflow \
    --log_tool wandb \
    --wandb_path ./ \
    --wandb_proj_name matching_dped \
    --wandb_exp_name pho_EVAL_zoom23_hp_dpedmsk_img224_bs12_lr1e4_croco_catseg_freezeCrocoAll_try1_CroCoNet_ep0057_fineflow \
    --wandb_log_img \
