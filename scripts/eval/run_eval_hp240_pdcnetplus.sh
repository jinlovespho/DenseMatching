...
CUDA_VISIBLE_DEVICES=${CUDA} python -u eval_matching.py \
    ...
    --model PDCNet_plus \
    --pre_trained_models pdcnet_plus \
    --path_to_pre_trained_models ./pretrained_weights/PDCNetModel_ep0016.pth.tar \
    --save_dir ./vis/eval/hp240_pdcnetplus_mytrain \
    --log_tool wandb \
    --wandb_path ./ \
    --wandb_proj_name matching_dped \
    --wandb_exp_name pho_EVAL_hp240_pdcnetplus_mytrain \
    --wandb_log_img \
