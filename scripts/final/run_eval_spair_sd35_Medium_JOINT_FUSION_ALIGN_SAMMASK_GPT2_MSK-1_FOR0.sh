                ...
                for inf_step_count in 1; do
                    ...
                    for msk_attn in -1; do   
                        ...
                        LOG_ARGS="
                            ...
                            --wandb_exp_name server5_spair_SORTED_VALSPLIT360_sd35_Medium_JOINT_FUSION_ALIGN_SAMMASK_step_max28_stop${stop_step}_count${inf_step_count}_${feat_type}_MASKATTN${msk_attn}_fusion_dim${fusion_dim}_layer${fusion_layer}_promptGPT2_gpu${CUDA} \
                            --save_dir ./vis/spair_SORTED_VALSPLIT360/sd35_Medium_JOINT/FUSION_ALIGN_SAMMASK_step_max28_stop${stop_step}_count${inf_step_count}_${feat_type}_MASKATTN${msk_attn}_fusion_dim${fusion_dim}_layer${fusion_layer}_promptGPT2 \
                        "
