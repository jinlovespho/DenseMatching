                ...
                for vis_layer in "9,10,11,12"; do
                    ...
                    for beta in -1; do
                        ...
                        LOG_ARGS="
                            ...
                            --wandb_exp_name server5_spair_SORTED_VALSPLIT360_sd3_JOINT_FLOWCAMAP_RECIP_BETA${beta}_step_max28_stop${stop_step}_count${inf_step_count}_${feat_type}_MASKATTN${msk_attn}_layer${vis_layer}_alignCorFalse_gpu${CUDA} \
                            --save_dir ./vis/spair_SORTED_VALSPLIT360/sd3_JOINT/FLOWCAMAP_RECIP_BETA${beta}_step_max28_stop${stop_step}_count${inf_step_count}_${feat_type}_MASKATTN${msk_attn}_layer${vis_layer} \
                        "
