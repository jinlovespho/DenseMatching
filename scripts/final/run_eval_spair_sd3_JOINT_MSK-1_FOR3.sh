            ...
            for inf_step_count in 1; do
                ...
                for msk_attn in -1; do   
                    ...
                    LOG_ARGS="
                        ...
                        --save_dir ./vis/spair_SORTED_VALSPLIT360/sd3_JOINT/step_max28_stop${stop_step}_count${inf_step_count}_${feat_type}_MASKATTN${msk_attn}_layer${layer} \
                    "
