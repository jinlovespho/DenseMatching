...
for epoch in 70 80 90; do 
    ...
    for corr in enc_feat; do
            ...
            CUDA_VISIBLE_DEVICES=${CUDA} python -u eval_matching.py \
                ...
                --correlation \
                --reciprocity \
                --save_dir ./vis/eval/hp240_dpedmsk_img224_bs12_lr1e4_croco_catseg_freezeCrocoAll_try3_CroCoNet_ep00${epoch} \
                --log_tool wandb \
                --wandb_path ./ \
                --wandb_proj_name matching_dped \
                --wandb_exp_name server8_pho${CUDA}_EVAL_CVPR2025REBUTTAL_hp240_dpedmsk_img224_bs12_lr1e4_croco_catseg_freezeCrocoAll_try3_CroCoNet_ep00${epoch} \
                --wandb_log_img \
