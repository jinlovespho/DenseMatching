    ...
    for feat_type in mmdit_attn_3_scaleshift; do
        ...
        for layer in 10; do
            ...
            LOG_ARGS="
                ...
                --wandb_exp_name server5_spair_SORTED_VALSPLIT360_sd3_SINGLE_maxstep28_stopstep${stop_step}_${feat_type}_layer${layer}_gpu${CUDA} \
                --save_dir ./vis/spair_SORTED_VALSPLIT360/sd3_SINGLE/maxstep28_stopstep${stop_step}_${feat_type}_layer${layer} \
            "
