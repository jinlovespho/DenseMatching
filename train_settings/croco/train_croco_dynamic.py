...
def run(settings):
    ...
    loss_module = MultiScaleFlow(level_weights=[1], loss_function=objective, downsample_gt_flow=True)

    # 6. Define actor
    GLUNetActor = CrocoBasedActor(model, objective=loss_module, objective_256=loss_module_256,
