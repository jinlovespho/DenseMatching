...
for epoch in 10 20 30 40 50 60; do 
    ...
    for dpt_head_input in query_feature; do
            ...
            CUDA_VISIBLE_DEVICES=${CUDA} python -u eval_matching.py \
                ...
                --save_dir ./vis/eval/hp240_CVPR2025REBUTTAL_dpedmsk_img224_bs64_lr1e-4_crocoflow_freezeCrocoAll_try2_CroCoNet_ep00${epoch} \
                --log_tool wandb \
                --wandb_path ./ \
                --wandb_proj_name matching_dped \
                --wandb_exp_name server8_pho${CUDA}_EVAL_hp240_CVPR2025REBUTTAL_dpedmsk_img224_bs64_lr1e-4_crocoflow_freezeCrocoAll_try2_CroCoNet_ep00${epoch} \
                --wandb_log_img 
    done
done
