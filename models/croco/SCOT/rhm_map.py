...
def hspace_bin_ids(src_imsize, src_box, trg_box, hs_cellsize, nbins_x):
    ...
    src_ptref = torch.tensor(src_imsize[:1], dtype=torch.float).to(src_box.device)
...
def rhm(src_hyperpixels, trg_hyperpixels, attn_map, hsfilter, sim, exp1, exp2, eps, ncells=8192):
