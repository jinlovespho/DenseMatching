...
"
    ...
    # --path_to_pre_trained_models /media/dataset3/jinlovespho/ckpt/DenseMatching_final/train_settings/croco/train_croco_static_multigpu_2stage/pho4,5,6_TRAIN_stage2_dpedcocomega_img224_bs12_lr1e5_crocov2_camap_freezeCrocoEnc_beta2e2_uncertainty/CroCoNet_model_best.pth.tar \
...
LOG_ARGS="
    ...
    --wandb_exp_name pho${CUDA}_TRAIN_stage2_dpedcocomega_img224_bs${BATCH_SIZE}_lr1e5_crocov2_camap_freezeCrocoEnc_beta1e4_uncertainty \
"
ETC_ARGS="
    --multi_gpu \
"
