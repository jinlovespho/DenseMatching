...
for epoch in 10 20 30 40 50 60; do 
    ...
    for corr in dec_feat; do
            ...
            CUDA_VISIBLE_DEVICES=${CUDA} python -u eval_matching.py \
                ...
                --path_to_pre_trained_models /home/cvlab08/projects/data/jinlovespho/dm_final/train_settings/croco/train_croco_static_stage1_multigpu/server8_pho0,1,2_TRAIN_CVPR2025REBUTTAL_dpedmsk_img224_bs12_lr1e4_croco_catseg_freezeCrocoAll_try2/CroCoNet_ep00${epoch}.pth.tar \
                --output_flow_interp \
                --output_ca_map \
                --softmax_camap \
                --correlation \
                --reciprocity \
                --save_dir ./vis/eval/hp240_dpedmsk_img224_bs12_lr1e4_croco_catseg_freezeCrocoAll_try2_CroCoNet_ep00${epoch} \
                --log_tool wandb \
                --wandb_path ./ \
                --wandb_proj_name matching_dped \
                --wandb_exp_name server8_pho${CUDA}_EVAL_CVPR2025REBUTTAL_hp240_dpedmsk_img224_bs12_lr1e4_croco_catseg_freezeCrocoAll_try2_CroCoNet_ep00${epoch} \
                --wandb_log_img \
