...
for epoch in 10 20 30 40 50 60; do 
    ...
    for corr in dec_feat; do
        ...
        CUDA_VISIBLE_DEVICES=${CUDA} python -u eval_matching.py \
            ...
            --correlation \
            --reciprocity \
            --save_dir ./vis/eval/hp_dpedmsk_img224_bs12_lr1e4_croco_catseg_freezeCrocoAll_try2_CroCoNet_ep00${epoch} \
            --log_tool wandb \
            --wandb_path ./ \
            --wandb_proj_name matching_dped \
            --wandb_exp_name server8_pho${CUDA}_EVAL_CVPR2025REBUTTAL_hp_dpedmsk_img224_bs12_lr1e4_croco_catseg_freezeCrocoAll_try2_CroCoNet_ep00${epoch} \
            --wandb_log_img \
